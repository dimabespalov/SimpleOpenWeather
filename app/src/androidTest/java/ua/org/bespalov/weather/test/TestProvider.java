...
public class TestProvider extends AndroidTestCase {
    ...
    static ContentValues createKalamazooLocationValues() {
        ...
        testValues.put(LocationEntry.COLUMN_LOC_SETTING, KALAMAZOO_LOCATION_SETTING);
        testValues.put(LocationEntry.COLUMN_LOC_NAME, "Kalamazoo");
        testValues.put(LocationEntry.COLUMN_LOC_LAT, 42.2917);
        testValues.put(LocationEntry.COLUMN_LOC_LONG, -85.5872);
